...
import com.android.praktikum.ecommerce.Admin.AdminHomeActivity;
import com.android.praktikum.ecommerce.Sellers.SellerProductCategoryActivity;
import com.android.praktikum.ecommerce.Model.Users;
                ...
                if(dataSnapshot.child(parentDbName).child(phone).exists()){
                    ...
                    if(usersData.getPhone().equals(phone)){
                        if(usersData.getPassword().equals(password)){
                           ...
                           {
                               Toast.makeText(LoginActivity.this, "Welcome Admin, you are log in Sucessfully...", Toast.LENGTH_SHORT).show();
                               loadingBar.dismiss();
